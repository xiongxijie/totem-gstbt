...
{
      printf("destroy pixbuf,  gst_sample_unref \n");
...
{
          printf("In totem_gst_playbin_get_frame \n");
  ...
  //map a GstMemory object to a user-accessible memory region. It allows the user to access the memory directly.
  ...
  //cleans up the mapping and ensures that the memory is properly released
  gst_memory_unmap (memory, &info);
  
  //decreases the reference count of a GstMemory object. When the reference count drops to zero, the memory is freed.
...
{     
                printf("In totem_gst_buffer_to_pixbuf \n");
...
{ 
          ...
          printf("In totem_gst_tag_list_get_cover \n");
